...
public class Solution2C2Activity extends AppCompatActivity {
        ...
        mRv.setAdapter(new RecyclerView.Adapter() {
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
                ...
                // TODO-C2 (10) Uncomment these 2 lines, assign image url of Feed to this url variable
                   String url = mFeeds.get(i).toImage_url();
    ...
    public void chooseImage() {
        ...
        startActivityForResult(Intent.createChooser(intent,"Seclect Picture"),PICK_IMAGE);
    ...
    public void chooseVideo() {
        ...
        intent.setAction(Intent.ACTION_GET_CONTENT);
        startActivityForResult(Intent.createChooser(intent,"Seclect Video"),PICK_VIDEO);
